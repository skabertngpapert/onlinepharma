<div class="container mt-5">
    <h4 class="font-montAlt font-size-20">Products</h4>
    <hr>
    
    <div class="col-12" id="productsForm">
        <div class="row">
        <div class="col-3"></div>
        <div class="col-3"></div>
        <div class="col-2"></div>
        <div class="col-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Use dash(-) instead of space for better results"><input class="form-control border-right-0 border my-search-bar" type="search" placeholder="Search" id="productSubmit" /></div>
        </div>
    </div>
     <div class="text-center">
     <div class="grid mb-2">
        <div id="productArea" class="row products-filter">
    <?php
