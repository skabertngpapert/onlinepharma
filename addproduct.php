...
if(isset($_POST['updateAdmin'])){
    ...
    $query = "INSERT INTO `products`( `name`, `brand`, `target`, `tag`, `price`, `description`, `stock`) VALUES ('" . $prodName . "','" . $prodBrand . "','" . $prodTarget . "','" . $prodTag . "'," . $prodPrice . ",'" . $prodDesc . "'," . $prodStock . ")";
    if(mysqli_query($conn, $query))
    {
    }
    else
    {
        echo 'Error Add Product:' . mysqli_error($conn);
    ...
    <!------ Include the above in your HEAD tag ---------->
        ...
        <div class="form-group">
            ...
            <label for="file-input">
                <img id ="prodImg" src="img/products/<?php echo $prodImg ;?>.jpg"  style="height: 20vh !important; width: 20vh" alt="Product Image">
            </label>
                <input type="file" name="product_image" id="file-input" accept=".jpg"/>
            </div>
        </div>
        ...
        <div class="col-md-2" >
            <button id="cancelAdd" name="cancelAdmin" style="width: 100% !important " class="btn btn-danger">cancel</button>
        </div>
        <div class="col-md-2" >
            <button id="acceptAdd" name="updateAdmin" style="width: 100% !important " class="btn btn-success">Update</button>
        </div>
        </div>
